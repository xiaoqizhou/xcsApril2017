...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		${P(E) \approx 1 - \frac{3}{n}\lambda }$\\
		\myansw
		\colorbox{yellow}{${P(E) \approx 1 - \frac{3}{8000}\times 0.9873=0.9996}$}\\
		\item
		\mysolu
		Let $n = 4000$, then $\lambda = e^{-18}\times 4000$\\
		\myansw
		\colorbox{yellow}{${P(E) \approx 1 - \frac{3}{4000}\times e^{-18}\times 4000 \approx 1 - 4.57 \times 10^{-8} \approx 1}$}\\
